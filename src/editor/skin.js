...
export const skinSchema = [
  {
    type: 'expandable', name: '', title: t(null, 'editor.skin.appearance', 'Skins & Appearance'), flatten: true,
    schema: [
      {
        name: 'skin',
        default: 'default',
...
export const skinHelpers = {
  theme_mode: t(null, 'editor.skin.helper_theme_mode', 'Force light or dark theme for skins that support it (Default, Google Home, Home Assistant, Kiosk Satellite, Waveform). "Auto" follows your HA theme setting.'),
